...
for ix =1:length(new_alpha)
    [theta_tmp, J_history_tmp] = gradientDescent(X, y, theta, new_alpha(ix), num_iters);
...
price = [1, (1600+mu(1))*sigma(1), (3+mu(2))*sigma(2)]*theta; % You should change this
...
% Estimate the price of a 1650 sq-ft, 3 br house
% ====================== YOUR CODE HERE ======================
price = [1, 1600, 3]*theta; % You should change this
