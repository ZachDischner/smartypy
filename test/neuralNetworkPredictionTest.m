...
for i = 1:m
    ...
    pred = predictNeuralNetwork(Theta1, Theta2, X(rp(i),:));
    pred_num = mod(pred,10);
    truth    = mod(y(rp(i)),10);
    title(sprintf('Neural Network Prediction:\t%d---\n\t      Truth Value:\t%d---',pred_num,truth))
